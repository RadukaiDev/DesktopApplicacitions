...
public class actualizarcodigo {
    ...
    public void insertar (JTextField paramNombre, JTextField paramApellidoP, JTextField paramApellidoM){
     ...
     public void actualizar (JTextField paramCodigo,JTextField paramNombre, JTextField paramApellidoP, JTextField paramApellidoM){
        ...
        String consulta = "update trabajadores set nombre = ?,apellido_p = ?,apellido_m = ? where id = ?;";
